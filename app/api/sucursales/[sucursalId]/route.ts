// app/api/sucursales/[sucursalId]/route.ts
...
export async function PATCH(
  req: Request,
  context: { params: Promise<{ sucursalId: string }> },
) {
  const { sucursalId } = await context.params
  const backendPath = `/sucursales/${sucursalId}`
