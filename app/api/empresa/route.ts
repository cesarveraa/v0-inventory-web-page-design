...
export async function GET(req: Request) {
  // GET /api/empresa -> GET /empresa
  return proxyJson(req, "/empresa", "GET")
}

export async function PUT(req: Request) {
  // PUT /api/empresa -> PUT /empresa
  return proxyJson(req, "/empresa", "PUT")
}

export async function DELETE(req: Request) {
  // DELETE /api/empresa -> DELETE /empresa
  return proxyJson(req, "/empresa", "DELETE")
}
